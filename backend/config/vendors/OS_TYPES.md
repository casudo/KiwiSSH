...
| Arris | C4CMTS | [arris_c4cmts](/backend/config/vendors/arris_c4cmts.yaml) | |
...
| Avaya | VOSS | [avaya_voss](/backend/config/vendors/avaya_voss.yaml) | VSP Operating System Software |
| Avaya | BOSS | [avaya_boss](/backend/config/vendors/avaya_boss.yaml) | Baystack Operating System Software |
...
| Cisco | FireLinuxOS | [cisco_firelinuxos.yaml](/backend/config/vendors/cisco_firelinuxos.yaml) | |
...
| Force10                  | FTOS                                                                                                                                        | [force10_ftos.yaml](/backend/config/vendors/force10_ftos.yaml)                             |                                                                          |
...
| Fujitsu | PRIMERGY | [fujitsu_primergy.yaml](/backend/config/vendors/fujitsu_primergy.yaml) | |
| Fujitsu | 1FINITY | [fujitsu_1finity.yaml](/backend/config/vendors/fujitsu_1finity.yaml) | | 
| Garderos | GRS | [garderos_grs.yaml](/backend/config/vendors/garderos_grs.yaml) | |
...
| HP | BladeSystem | [hp_bladesystem.yaml](/backend/config/vendors/hp_bladesystem.yaml) | |
...
| HP | MSA | [hp_msa.yaml](/backend/config/vendors/hp_msa.yaml) | |
| HP | MSM (Wireless Controller) | [hp_msm.yaml](/backend/config/vendors/hp_msm.yaml) | | 
...
| MRV | FiberDriver | [mrv_fiberdriver.yaml](/backend/config/vendors/mrv_fiberdriver.yaml) | |
...
| Quanta                   | Quanta / VxWorks 6.6 (1.1.0.8)                                                                                                              | [quanta_quantaos.yaml](/backend/config/vendors/quanta_quantaos.yaml)                       |                                                                          |
...
| Waystream (PacketFront)  | iBOS (Intelligent Broadband OS)                                                                                                             | [waystream_ibos.yaml](/backend/config/vendors/waystream_ibos.yaml)                         |                                                                          |
